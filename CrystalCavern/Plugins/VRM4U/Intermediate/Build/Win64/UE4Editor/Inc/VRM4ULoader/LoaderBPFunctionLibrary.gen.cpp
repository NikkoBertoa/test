...
// Cross Module References
	...
	VRM4ULOADER_API UScriptStruct* Z_Construct_UScriptStruct_FMeshInfo();
...
static struct FScriptStruct_VRM4ULoader_StaticRegisterNativesFReturnedData
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FReturnedData_Hash() { return 1334287811U; }
class UScriptStruct* FMeshInfo::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern VRM4ULOADER_API uint32 Get_Z_Construct_UScriptStruct_FMeshInfo_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FMeshInfo, Z_Construct_UPackage__Script_VRM4ULoader(), TEXT("MeshInfo"), sizeof(FMeshInfo), Get_Z_Construct_UScriptStruct_FMeshInfo_Hash());
	}
	return Singleton;
}
template<> VRM4ULOADER_API UScriptStruct* StaticStruct<FMeshInfo>()
{
	return FMeshInfo::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FMeshInfo(FMeshInfo::StaticStruct, TEXT("/Script/VRM4ULoader"), TEXT("MeshInfo"), false, nullptr, nullptr);
static struct FScriptStruct_VRM4ULoader_StaticRegisterNativesFMeshInfo
{
	FScriptStruct_VRM4ULoader_StaticRegisterNativesFMeshInfo()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("MeshInfo")),new UScriptStruct::TCppStructOps<FMeshInfo>);
	}
} ScriptStruct_VRM4ULoader_StaticRegisterNativesFMeshInfo;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMeshInfo_Statics::NewProp_Triangles2_MetaData[] = {
		{ "Category", "ReturnedData" },
		{ "ModuleRelativePath", "Public/LoaderBPFunctionLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMeshInfo_Statics::NewProp_Triangles2 = { "Triangles2", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMeshInfo, Triangles2), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMeshInfo_Statics::NewProp_Triangles2_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMeshInfo_Statics::NewProp_Triangles2_MetaData)) };
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMeshInfo_Statics::NewProp_Triangles2_Inner = { "Triangles2", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FMeshInfo_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMeshInfo_Statics::NewProp_Triangles2,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMeshInfo_Statics::NewProp_Triangles2_Inner,
	...
	uint32 Get_Z_Construct_UScriptStruct_FMeshInfo_Hash() { return 3352453172U; }
	...
	IMPLEMENT_CLASS(ULoaderBPFunctionLibrary, 4274248165);
