...
static struct FScriptStruct_VMC4UE_StaticRegisterNativesFVMC4UEVRMMappingData
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("VMC4UEVRMMappingData")),new UScriptStruct::TCppStructOps<FVMC4UEVRMMappingData>);
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FVMC4UEVRMMappingData_Hash() { return 2402537034U; }
...
static struct FScriptStruct_VMC4UE_StaticRegisterNativesFVMC4UEBlendShape
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("VMC4UEBlendShape")),new UScriptStruct::TCppStructOps<FVMC4UEBlendShape>);
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FVMC4UEBlendShape_Hash() { return 2445263451U; }
...
static struct FScriptStruct_VMC4UE_StaticRegisterNativesFVMC4UEBlendShapeClip
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("VMC4UEBlendShapeClip")),new UScriptStruct::TCppStructOps<FVMC4UEBlendShapeClip>);
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FVMC4UEBlendShapeClip_Hash() { return 1348113607U; }
...
static struct FScriptStruct_VMC4UE_StaticRegisterNativesFVMC4UEBlendShapeMeshState
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("VMC4UEBlendShapeMeshState")),new UScriptStruct::TCppStructOps<FVMC4UEBlendShapeMeshState>);
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FVMC4UEBlendShapeMeshState_Hash() { return 3785202409U; }
...
static struct FScriptStruct_VMC4UE_StaticRegisterNativesFVMC4UEBlendShapeState
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("VMC4UEBlendShapeState")),new UScriptStruct::TCppStructOps<FVMC4UEBlendShapeState>);
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FVMC4UEBlendShapeState_Hash() { return 2925780814U; }
...
static struct FScriptStruct_VMC4UE_StaticRegisterNativesFVMC4UEBlendShapeMesh
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("VMC4UEBlendShapeMesh")),new UScriptStruct::TCppStructOps<FVMC4UEBlendShapeMesh>);
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FVMC4UEBlendShapeMesh_Hash() { return 3160369299U; }
...
static struct FScriptStruct_VMC4UE_StaticRegisterNativesFVMC4UEBoneMapping
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("VMC4UEBoneMapping")),new UScriptStruct::TCppStructOps<FVMC4UEBoneMapping>);
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FVMC4UEBoneMapping_Hash() { return 3426885500U; }
