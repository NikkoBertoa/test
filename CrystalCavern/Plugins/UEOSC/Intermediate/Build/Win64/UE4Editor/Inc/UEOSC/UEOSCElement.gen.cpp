...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_UEOSC_EUEOSCElementType_Hash() { return 3196661317U; }
...
static struct FScriptStruct_UEOSC_StaticRegisterNativesFUEOSCMessage
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("UEOSCMessage")),new UScriptStruct::TCppStructOps<FUEOSCMessage>);
	}
...
static struct FScriptStruct_UEOSC_StaticRegisterNativesFUEOSCElement
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("UEOSCElement")),new UScriptStruct::TCppStructOps<FUEOSCElement>);
	}
